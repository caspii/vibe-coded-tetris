...
A complete, polished Tetris game built entirely by AI (Claude) in a single prompt. No human wrote a single line of code.

**[Play it live](https://caspii.github.io/vibe-coded-tetris/)**

## Features

- All 7 standard tetrominoes with SRS (Super Rotation System) and wall kicks
- Ghost piece, hold piece, next piece preview
- Hard drop, soft drop, DAS auto-repeat
- Line clearing with animations, scoring (100/300/500/800 × level)
- Level progression every 10 lines
- Lock delay with move resets
- Web Audio API synth sounds (move, rotate, drop, clear, tetris, game over)
- Mobile touch controls
- Dark neon theme with particle effect landing page
...
Everything lives in a single `index.html` file — no build step, no dependencies (except Google Fonts). Uses CSS Grid for the board and `requestAnimationFrame` for the game loop.

---

## The Prompt

The entire game was generated from the following prompt given to Claude:
